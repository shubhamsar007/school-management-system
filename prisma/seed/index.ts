...
async function main() {
  ...
  const employeeData = [
    ...
    // ── Mathematics ─────────────────────────────────────────────────────────────
    { empNo: 'EMP-001', fn: 'Anjali',   ln: 'Sharma',    g: 'FEMALE', dob: '1980-03-15', email: 'anjali.sharma@sunriseschool.edu.in',     ph: '+91-9810001001', dept: 'TEACH',   desig: 'HOD',          et: 'PERM_TEACH',     j: '2015-06-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-007', fn: 'Sunita',   ln: 'Rao',       g: 'FEMALE', dob: '1979-12-01', email: 'sunita.rao@sunriseschool.edu.in',        ph: '+91-9810001007', dept: 'TEACH',   desig: 'SR_TEACHER',   et: 'PERM_TEACH',     j: '2008-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A-' },
    { empNo: 'EMP-012', fn: 'Suresh',   ln: 'Gupta',     g: 'MALE',   dob: '1977-10-08', email: 'suresh.gupta@sunriseschool.edu.in',      ph: '+91-9810001012', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2005-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O+' },
    { empNo: 'EMP-028', fn: 'Tejal',    ln: 'Shah',      g: 'FEMALE', dob: '1985-06-12', email: 'tejal.shah@sunriseschool.edu.in',        ph: '+91-9810002800', dept: 'TEACH',   desig: 'SR_TEACHER',   et: 'PERM_TEACH',     j: '2013-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B-' },
    { empNo: 'EMP-029', fn: 'Prem',     ln: 'Chandra',   g: 'MALE',   dob: '1990-03-22', email: 'prem.chandra@sunriseschool.edu.in',      ph: '+91-9810002900', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2016-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-030', fn: 'Fatima',   ln: 'Siddiqui',  g: 'FEMALE', dob: '1992-11-08', email: 'fatima.siddiqui@sunriseschool.edu.in',  ph: '+91-9810003000', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2018-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'AB+' },
    { empNo: 'EMP-055', fn: 'Rohit',    ln: 'Saxena',    g: 'MALE',   dob: '1994-07-30', email: 'rohit.saxena@sunriseschool.edu.in',      ph: '+91-9810005500', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2021-06-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O-' },
    { empNo: 'EMP-031', fn: 'Arun',     ln: 'Bhat',      g: 'MALE',   dob: '1997-04-15', email: 'arun.bhat@sunriseschool.edu.in',         ph: '+91-9810003100', dept: 'TEACH',   desig: 'ASST_TEACHER', et: 'CONTRACT_TEACH', j: '2023-06-01', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-060', fn: 'Shreya',   ln: 'Pillai',    g: 'FEMALE', dob: '1999-02-18', email: 'shreya.pillai@sunriseschool.edu.in',    ph: '+91-9810006000', dept: 'TEACH',   desig: 'ASST_TEACHER', et: 'CONTRACT_TEACH', j: '2024-06-01', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'A+' },
    // ── Science ──────────────────────────────────────────────────────────────────
    { empNo: 'EMP-022', fn: 'Narender', ln: 'Kumar',     g: 'MALE',   dob: '1973-05-25', email: 'narender.kumar@sunriseschool.edu.in',   ph: '+91-9810002200', dept: 'TEACH',   desig: 'HOD',          et: 'PERM_TEACH',     j: '2007-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-002', fn: 'Ramesh',   ln: 'Verma',     g: 'MALE',   dob: '1975-07-22', email: 'ramesh.verma@sunriseschool.edu.in',     ph: '+91-9810001002', dept: 'TEACH',   desig: 'SR_TEACHER',   et: 'PERM_TEACH',     j: '2010-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O+' },
    { empNo: 'EMP-032', fn: 'Vinita',   ln: 'Patel',     g: 'FEMALE', dob: '1987-09-14', email: 'vinita.patel@sunriseschool.edu.in',     ph: '+91-9810003200', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2015-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-033', fn: 'Gopal',    ln: 'Soni',      g: 'MALE',   dob: '1989-02-07', email: 'gopal.soni@sunriseschool.edu.in',       ph: '+91-9810003300', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2017-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O-' },
    { empNo: 'EMP-056', fn: 'Varsha',   ln: 'Gupta',     g: 'FEMALE', dob: '1993-12-20', email: 'varsha.gupta@sunriseschool.edu.in',     ph: '+91-9810005600', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2021-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-008', fn: 'Kiran',    ln: 'Mehta',     g: 'MALE',   dob: '1992-04-19', email: 'kiran.mehta@sunriseschool.edu.in',      ph: '+91-9810001008', dept: 'TEACH',   desig: 'ASST_TEACHER', et: 'CONTRACT_TEACH', j: '2022-06-01', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'A-' },
    { empNo: 'EMP-034', fn: 'Mamta',    ln: 'Rawat',     g: 'FEMALE', dob: '1998-07-11', email: 'mamta.rawat@sunriseschool.edu.in',      ph: '+91-9810003400', dept: 'TEACH',   desig: 'ASST_TEACHER', et: 'CONTRACT_TEACH', j: '2024-04-01', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'AB-' },
    { empNo: 'EMP-015', fn: 'Lakshmi',  ln: 'Pillai',    g: 'FEMALE', dob: '1986-09-29', email: 'lakshmi.pillai@sunriseschool.edu.in',  ph: '+91-9810001015', dept: 'SUPPORT', desig: 'LAB_ASST',     et: 'PERM_NON_TEACH', j: '2013-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-053', fn: 'Nirmala',  ln: 'Thakur',    g: 'FEMALE', dob: '1991-03-05', email: 'nirmala.thakur@sunriseschool.edu.in',  ph: '+91-9810005300', dept: 'SUPPORT', desig: 'LAB_ASST',     et: 'PERM_NON_TEACH', j: '2017-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O+' },
    { empNo: 'EMP-054', fn: 'Deepak',   ln: 'Malhotra',  g: 'MALE',   dob: '1995-10-28', email: 'deepak.malhotra@sunriseschool.edu.in', ph: '+91-9810005400', dept: 'SUPPORT', desig: 'LAB_ASST',     et: 'CONTRACT_NON',   j: '2022-07-01', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'B-' },
    { empNo: 'EMP-020', fn: 'Pooja',    ln: 'Chauhan',   g: 'FEMALE', dob: '1996-12-25', email: 'pooja.chauhan@sunriseschool.edu.in',   ph: '+91-9810001020', dept: 'SUPPORT', desig: 'LAB_ASST',     et: 'CONTRACT_NON',   j: '2024-01-15', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-061', fn: 'Mukesh',   ln: 'Jha',       g: 'MALE',   dob: '1998-05-14', email: 'mukesh.jha@sunriseschool.edu.in',      ph: '+91-9810006100', dept: 'TEACH',   desig: 'ASST_TEACHER', et: 'CONTRACT_TEACH', j: '2024-07-01', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'O+' },
    // ── English ──────────────────────────────────────────────────────────────────
    { empNo: 'EMP-023', fn: 'Divya',    ln: 'Menon',     g: 'FEMALE', dob: '1976-11-30', email: 'divya.menon@sunriseschool.edu.in',      ph: '+91-9810002300', dept: 'TEACH',   desig: 'HOD',          et: 'PERM_TEACH',     j: '2009-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-009', fn: 'Deepa',    ln: 'Krishnan',  g: 'FEMALE', dob: '1987-08-23', email: 'deepa.krishnan@sunriseschool.edu.in',  ph: '+91-9810001009', dept: 'TEACH',   desig: 'SR_TEACHER',   et: 'PERM_TEACH',     j: '2014-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-003', fn: 'Priya',    ln: 'Nair',      g: 'FEMALE', dob: '1988-11-05', email: 'priya.nair@sunriseschool.edu.in',      ph: '+91-9810001003', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2018-07-15', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O+' },
    { empNo: 'EMP-035', fn: 'Manish',   ln: 'Pandey',    g: 'MALE',   dob: '1990-08-19', email: 'manish.pandey@sunriseschool.edu.in',   ph: '+91-9810003500', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2016-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-036', fn: 'Smita',    ln: 'Naik',      g: 'FEMALE', dob: '1993-01-14', email: 'smita.naik@sunriseschool.edu.in',      ph: '+91-9810003600', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2019-06-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A-' },
    { empNo: 'EMP-057', fn: 'Alka',     ln: 'Jain',      g: 'FEMALE', dob: '1995-09-03', email: 'alka.jain@sunriseschool.edu.in',       ph: '+91-9810005700', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2022-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O+' },
    { empNo: 'EMP-013', fn: 'Neha',     ln: 'Agarwal',   g: 'FEMALE', dob: '1995-03-22', email: 'neha.agarwal@sunriseschool.edu.in',    ph: '+91-9810001013', dept: 'TEACH',   desig: 'ASST_TEACHER', et: 'VISITING',       j: '2024-06-01', status: 'ACTIVE',         eType: 'PART_TIME', bg: 'B+' },
    { empNo: 'EMP-037', fn: 'Harish',   ln: 'Bisht',     g: 'MALE',   dob: '1997-06-22', email: 'harish.bisht@sunriseschool.edu.in',    ph: '+91-9810003700', dept: 'TEACH',   desig: 'ASST_TEACHER', et: 'CONTRACT_TEACH', j: '2024-07-01', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'AB+' },
    { empNo: 'EMP-062', fn: 'Leela',    ln: 'Prasad',    g: 'FEMALE', dob: '1999-11-09', email: 'leela.prasad@sunriseschool.edu.in',    ph: '+91-9810006200', dept: 'TEACH',   desig: 'ASST_TEACHER', et: 'CONTRACT_TEACH', j: '2024-07-01', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'A+' },
    // ── Social Studies ───────────────────────────────────────────────────────────
    { empNo: 'EMP-024', fn: 'Rakesh',   ln: 'Tripathi',  g: 'MALE',   dob: '1971-08-14', email: 'rakesh.tripathi@sunriseschool.edu.in', ph: '+91-9810002400', dept: 'TEACH',   desig: 'HOD',          et: 'PERM_TEACH',     j: '2006-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-014', fn: 'Mohan',    ln: 'Das',       g: 'MALE',   dob: '1982-07-11', email: 'mohan.das@sunriseschool.edu.in',        ph: '+91-9810001014', dept: 'TEACH',   desig: 'SR_TEACHER',   et: 'PERM_TEACH',     j: '2011-04-01', status: 'ON_LEAVE',       eType: 'FULL_TIME', bg: 'O-' },
    { empNo: 'EMP-038', fn: 'Gita',     ln: 'Rao',       g: 'FEMALE', dob: '1983-04-27', email: 'gita.rao@sunriseschool.edu.in',         ph: '+91-9810003800', dept: 'TEACH',   desig: 'SR_TEACHER',   et: 'PERM_TEACH',     j: '2012-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-004', fn: 'Vikram',   ln: 'Singh',     g: 'MALE',   dob: '1985-02-28', email: 'vikram.singh@sunriseschool.edu.in',    ph: '+91-9810001004', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2016-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B-' },
    { empNo: 'EMP-039', fn: 'Ajay',     ln: 'Bansal',    g: 'MALE',   dob: '1989-10-15', email: 'ajay.bansal@sunriseschool.edu.in',     ph: '+91-9810003900', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2017-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O+' },
    { empNo: 'EMP-040', fn: 'Ritu',     ln: 'Sharma',    g: 'FEMALE', dob: '1993-06-02', email: 'ritu.sharma@sunriseschool.edu.in',     ph: '+91-9810004000', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2020-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-058', fn: 'Naveen',   ln: 'Rao',       g: 'MALE',   dob: '1995-03-17', email: 'naveen.rao@sunriseschool.edu.in',      ph: '+91-9810005800', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2022-06-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-065', fn: 'Tara',     ln: 'Devi',      g: 'FEMALE', dob: '1978-09-01', email: 'tara.devi@sunriseschool.edu.in',       ph: '+91-9810006500', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2008-04-01', status: 'EXIT_INITIATED', eType: 'FULL_TIME', bg: 'O+' },
    // ── Computer Science ─────────────────────────────────────────────────────────
    { empNo: 'EMP-025', fn: 'Anjana',   ln: 'Sinha',     g: 'FEMALE', dob: '1979-12-20', email: 'anjana.sinha@sunriseschool.edu.in',    ph: '+91-9810002500', dept: 'TEACH',   desig: 'HOD',          et: 'PERM_TEACH',     j: '2011-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A-' },
    { empNo: 'EMP-042', fn: 'Sandhya',  ln: 'Tyagi',     g: 'FEMALE', dob: '1984-07-09', email: 'sandhya.tyagi@sunriseschool.edu.in',  ph: '+91-9810004200', dept: 'TEACH',   desig: 'SR_TEACHER',   et: 'PERM_TEACH',     j: '2014-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-005', fn: 'Meena',    ln: 'Iyer',      g: 'FEMALE', dob: '1990-06-10', email: 'meena.iyer@sunriseschool.edu.in',      ph: '+91-9810001005', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2019-06-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O+' },
    { empNo: 'EMP-041', fn: 'Prakash',  ln: 'Mishra',    g: 'MALE',   dob: '1991-04-23', email: 'prakash.mishra@sunriseschool.edu.in', ph: '+91-9810004100', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2018-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-059', fn: 'Pooja',    ln: 'Mathur',    g: 'FEMALE', dob: '1994-08-16', email: 'pooja.mathur@sunriseschool.edu.in',   ph: '+91-9810005900', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2022-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B-' },
    { empNo: 'EMP-010', fn: 'Rahul',    ln: 'Joshi',     g: 'MALE',   dob: '1993-01-30', email: 'rahul.joshi@sunriseschool.edu.in',    ph: '+91-9810001010', dept: 'TEACH',   desig: 'ASST_TEACHER', et: 'CONTRACT_TEACH', j: '2023-06-01', status: 'PROBATION',      eType: 'FULL_TIME', bg: 'O+' },
    // ── Physical Education ───────────────────────────────────────────────────────
    { empNo: 'EMP-026', fn: 'Baldev',   ln: 'Rana',      g: 'MALE',   dob: '1975-01-30', email: 'baldev.rana@sunriseschool.edu.in',     ph: '+91-9810002600', dept: 'TEACH',   desig: 'HOD',          et: 'PERM_TEACH',     j: '2008-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-006', fn: 'Arjun',    ln: 'Patel',     g: 'MALE',   dob: '1983-09-14', email: 'arjun.patel@sunriseschool.edu.in',    ph: '+91-9810001006', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2012-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-043', fn: 'Rahul',    ln: 'Bhatt',     g: 'MALE',   dob: '1993-07-07', email: 'rahul.bhatt@sunriseschool.edu.in',    ph: '+91-9810004300', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2019-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O+' },
    { empNo: 'EMP-044', fn: 'Anjali',   ln: 'Verma',     g: 'FEMALE', dob: '1996-05-23', email: 'anjali.verma@sunriseschool.edu.in',   ph: '+91-9810004400', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2022-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A-' },
    // ── Arts & Craft ─────────────────────────────────────────────────────────────
    { empNo: 'EMP-027', fn: 'Madhuri',  ln: 'Desai',     g: 'FEMALE', dob: '1978-03-14', email: 'madhuri.desai@sunriseschool.edu.in',  ph: '+91-9810002700', dept: 'TEACH',   desig: 'HOD',          et: 'PERM_TEACH',     j: '2010-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'A+' },
    { empNo: 'EMP-011', fn: 'Kavya',    ln: 'Reddy',     g: 'FEMALE', dob: '1991-05-17', email: 'kavya.reddy@sunriseschool.edu.in',    ph: '+91-9810001011', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2020-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-045', fn: 'Vinod',    ln: 'Saxena',    g: 'MALE',   dob: '1988-12-01', email: 'vinod.saxena@sunriseschool.edu.in',   ph: '+91-9810004500', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2016-07-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O+' },
    { empNo: 'EMP-046', fn: 'Preethi',  ln: 'Kumar',     g: 'FEMALE', dob: '1992-09-25', email: 'preethi.kumar@sunriseschool.edu.in', ph: '+91-9810004600', dept: 'TEACH',   desig: 'TEACHER',      et: 'PERM_TEACH',     j: '2019-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B-' },
    // ── Administration ───────────────────────────────────────────────────────────
    ...
    // ── Support Staff ────────────────────────────────────────────────────────────
    { empNo: 'EMP-063', fn: 'Ravi',     ln: 'Shankar',   g: 'MALE',   dob: '1975-02-28', email: 'ravi.shankar@sunriseschool.edu.in',  ph: '+91-9810006300', dept: 'SUPPORT', desig: 'PEON',         et: 'PERM_NON_TEACH', j: '2003-06-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'B+' },
    { empNo: 'EMP-064', fn: 'Kamal',    ln: 'Mishra',    g: 'MALE',   dob: '1982-10-19', email: 'kamal.mishra@sunriseschool.edu.in',  ph: '+91-9810006400', dept: 'SUPPORT', desig: 'PEON',         et: 'PERM_NON_TEACH', j: '2015-04-01', status: 'ACTIVE',         eType: 'FULL_TIME', bg: 'O-' },
  ];
